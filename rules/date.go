...
// due date has passed. This function expects that invoiceItem is not nil.
...
func PaidOnTime(invoiceItem *types.InvoiceItem, receivablesItem *types.ReceivablesItem) (bool, error) {
	if receivablesItem != nil && invoiceItem != nil && invoiceItem.DueDate.After(*receivablesItem.Date) {
